...
const BasketModal = ({ basket, removeFromBasket, removeAllFromBasket, basketModalInvisible }) => {
        ...
        <div className="backdrop">
          <div className="modal">
            ...
            <div className="basket-header">
              <button onClick={basketModalInvisible}>Close❌</button>
              <h3 className='basket-heading'>Basket ({basket.length})</h3>
              <button onClick={removeAllFromBasket} className='basket-removeAll'>Remove All</button>
            </div>
